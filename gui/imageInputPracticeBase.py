...
class imgInputPracticeBase ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		sbSizer4 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel2, wx.ID_ANY, u"模式" ), wx.VERTICAL )
		
		self.m_radioBtn1 = wx.RadioButton( self.m_panel2, wx.ID_ANY, u"练习模式", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_radioBtn1.SetValue( True ) 
		sbSizer4.Add( self.m_radioBtn1, 0, wx.ALL, 5 )
		
		self.m_radioBtn2 = wx.RadioButton( self.m_panel2, wx.ID_ANY, u"2模式", wx.DefaultPosition, wx.DefaultSize, 0 )
		sbSizer4.Add( self.m_radioBtn2, 0, wx.ALL, 5 )
		
		
		gbSizer3.Add( sbSizer4, wx.GBPosition( 0, 0 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		
		sbSizer1 = wx.StaticBoxSizer( wx.StaticBox( self.m_panel2, wx.ID_ANY, u"统计" ), wx.VERTICAL )
		...
		gbSizer3.Add( sbSizer1, wx.GBPosition( 1, 0 ), wx.GBSpan( 1, 1 ), wx.EXPAND, 5 )
		...
		gbSizer2.Add( self.m_panel3, wx.GBPosition( 0, 1 ), wx.GBSpan( 1, 1 ), wx.EXPAND |wx.ALL, 5 )
